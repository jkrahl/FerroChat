...
.controller('UserMessagesCtrl', ['$scope', '$rootScope', '$state',
  ...
  function($scope, $rootScope, $state, $stateParams, MockService,
    ...
    $scope.toUser = {
      ...
      pic: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/FGC_logo_%282019%29.svg/768px-FGC_logo_%282019%29.svg.png',
      username: 'Ferrita'
    }
...
function getMockMessages() {
  return {"messages":[{"_id":"535f13ffee3b2a68112b9fc0","text":"Hola, Soc la ferrita, en que et puc ayudar-te avui? ","userId":"534b8e5aaa5e7afc1b23e69b","date":new Date(),"read":true,"readDate":new Date(),}],"unread":0};
}
